...
class Storage:
    ...
    def __init__(self):
        ...
        self.dest_path_submission = os.path.join(
    ...
    def upload_file_to_bucket(self):
        ...
        filename = 'sec-submissions-{}.zip'.format(
    ...
    def download_zip_file(self):
        ...
        temp_file = tempfile.NamedTemporaryFile(
            dir='/media/shivam/backup/data')

        # Set the User-Agent header
        headers = {'User-Agent': os.getenv('COMPANY')}

        # Download the file from the URL
        response = requests.get(self.submission_url,
